...
#define startTimeout() (timeout_start_ms = codal::system_timer_current_time())

// Check if timeout is enabled (set to nonzero value) and has expired
#define checkTimeoutExpired() (io_timeout > 0 && ((uint16_t)codal::system_timer_current_time() - timeout_start_ms) > io_timeout)
...
void VL53L0X::writeReg(uint8_t reg, uint8_t value)
{
  ...
  i2c_buf[0] = reg;
  i2c_buf[1] = value;
  _i2c.write(address, (char*)i2c_buf, 2, false);
}
...
void VL53L0X::writeReg16Bit(uint8_t reg, uint16_t value)
{
  uint8_t i2c_buf[3];
  i2c_buf[0] = reg;
  i2c_buf[1] = (value >> 8) & 0xFF;
  i2c_buf[2] =  value       & 0xFF;
  _i2c.write(address, (char*)i2c_buf, 3, false);
}
...
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value)
{
  ...
  _i2c.write(address, (char*)i2c_buf, 5, false);
}
...
uint8_t VL53L0X::readReg(uint8_t reg)
{
  uint8_t i2c_buf[2];
  i2c_buf[0] = reg;
  _i2c.write(address, (char*)i2c_buf, 1, true);
  _i2c.read(address, (char*)i2c_buf, 1, false);
  return i2c_buf[0];
}
...
uint16_t VL53L0X::readReg16Bit(uint8_t reg)
{
  ...
  i2c_buf[0] = reg;
  _i2c.write(address, (char*)i2c_buf, 1, true);
  _i2c.read(address, (char*)i2c_buf, 2, false);

  value  = (uint16_t)i2c_buf[0] << 8; // value high byte
  value |=           i2c_buf[1];      // value low byte
...
uint32_t VL53L0X::readReg32Bit(uint8_t reg)
{
  ...
  i2c_buf[0] = reg;
  _i2c.write(address, (char*)i2c_buf, 1, true);
  _i2c.read(address, (char*)i2c_buf,  4, false);

  value  = (uint32_t)i2c_buf[0] << 24; // value highest byte
  value |= (uint32_t)i2c_buf[0] << 16;
  value |= (uint16_t)i2c_buf[0] <<  8;
  value |=           i2c_buf[0];       // value lowest byte
...
void VL53L0X::writeMulti(uint8_t reg, uint8_t const * src, uint8_t count)
{
  ...
  i2c_buf[0] = reg;
  _i2c.write(address, (char*)i2c_buf, 1, true);
  _i2c.write(address, (char*)src, count, false);
...
void VL53L0X::readMulti(uint8_t reg, uint8_t * dst, uint8_t count)
{
  ...
  i2c_buf[0] = reg;
  _i2c.write(address, (char*)i2c_buf, 1, true);
  _i2c.read(address, (char*)dst, count, false);
}
